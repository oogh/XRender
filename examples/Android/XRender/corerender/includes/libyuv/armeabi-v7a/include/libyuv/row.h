...
#define HAS_ABGRTOUVJ444ROW_NEON
...
#define HAS_ARGBTOUV422ROW_NEON //use to caculate I422
...
void ARGBToY422Row_NEON(const uint8* src_argb, uint8* dst_y, int width);
...
void ABGRToUV444Row_NEON(const uint8* src_abgr,
                         ...
                         uint8* dst_v,
                         int width);
void ABGRToUVJ444Row_NEON(const uint8* src_abgr,
                         uint8* dst_u,
                         uint8* dst_v,
                         int width);
...
void ARGBToUV422Row_NEON(const uint8* src_argb,
                         ...
                         uint8* dst_u,
                         uint8* dst_v,
                         int width);  //use to caculate I422
...
void ABGRToUV444Row_Any_NEON(const uint8* src_abgr,
                             ...
                             uint8* dst_v,
                             int width);
void ABGRToUVJ444Row_Any_NEON(const uint8* src_abgr,
                             uint8* dst_u,
                             uint8* dst_v,
                             int width);
...
void ABGRToUVJ444Row_C(const uint8* src_abgr,
                       uint8* dst_u,
                       uint8* dst_v,
                       int width);
...
void I400ToABGRRow_C(const uint8* src_y, uint8* dst_argb, int width);
