...
#define HAS_SCALEARGBROWDOWN3_NEON
...
void ScaleARGBRowDown2Box_C(const uint8* src_argb,
                            ...
                            uint8* dst_argb,
                            int dst_width);
void ScaleARGBRowDown3_C(const uint8* src_argb,
                         ptrdiff_t src_stride,
                         uint8* dst_argb,
                         int dst_width);
void ScaleARGBRowDown3Linear_C(const uint8* src_argb,
                               ptrdiff_t src_stride,
                               uint8* dst_argb,
                               int dst_width);
void ScaleARGBRowDown3BiLinear_C(const uint8* src_argb,
                                 ptrdiff_t src_stride,
                                 uint8* dst_argb,
                                 int dst_width);
void ScaleARGBRowDown3Box_C(const uint8* src_argb,
                            ptrdiff_t src_stride,
                            uint8* dst_argb,
                            int dst_width);
...
void ScaleARGBRowDown2_NEON(const uint8* src_ptr,
                            ...
                            uint8* dst,
                            int dst_width);
void ScaleARGBRowDown3_NEON(const uint8* src_ptr,
                            ptrdiff_t src_stride,
                            uint8* dst,
                            int dst_width);
void ScaleARGBRowDown2Linear_NEON(const uint8* src_argb,
                                  ...
                                  uint8* dst_argb,
                                  int dst_width);
void ScaleARGBRowDown3Linear_NEON(const uint8* src_argb,
                                  ptrdiff_t src_stride,
                                  uint8* dst_argb,
                                  int dst_width);
void ScaleARGBRowDown3BiLinear_NEON(const uint8* src_argb,
                                  ptrdiff_t src_stride,
                                  uint8* dst_argb,
                                  int dst_width);
void ScaleARGBRowDown2Box_NEON(const uint8* src_ptr,
                               ...
                               uint8* dst,
                               int dst_width);
void ScaleARGBRowDown3Box_NEON(const uint8* src_ptr,
                               ptrdiff_t src_stride,
                               uint8* dst,
                               int dst_width);
...
void ScaleARGBRowDown2_Any_NEON(const uint8* src_ptr,
                                ...
                                uint8* dst,
                                int dst_width);
void ScaleARGBRowDown3_Any_NEON(const uint8* src_ptr,
                                ptrdiff_t src_stride,
                                uint8* dst,
                                int dst_width);
void ScaleARGBRowDown2Linear_Any_NEON(const uint8* src_argb,
                                      ...
                                      uint8* dst_argb,
                                      int dst_width);
void ScaleARGBRowDown3Linear_Any_NEON(const uint8* src_argb,
                                      ptrdiff_t src_stride,
                                      uint8* dst_argb,
                                      int dst_width);
void ScaleARGBRowDown3BiLinear_Any_NEON(const uint8* src_argb,
                                        ptrdiff_t src_stride,
                                        uint8* dst_argb,
                                        int dst_width);
void ScaleARGBRowDown2Box_Any_NEON(const uint8* src_ptr,
                                   ...
                                   uint8* dst,
                                   int dst_width);
void ScaleARGBRowDown3Box_Any_NEON(const uint8* src_ptr,
                                   ptrdiff_t src_stride,
                                   uint8* dst,
                                   int dst_width);
