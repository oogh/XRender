...
LIBYUV_API
int J444ToABGR(const uint8* src_y,
               int src_stride_y,
               const uint8* src_u,
               int src_stride_u,
               const uint8* src_v,
...
// Convert I400 (grey) to ABGR.  Reverse of ABGRToI400.
LIBYUV_API
int I400ToABGR(const uint8* src_y,
               int src_stride_y,
               uint8* dst_argb,
               int dst_stride_argb,
               int width,
...
// Convert J400 (jpeg grey) to ABGR.
LIBYUV_API
int J400ToABGR(const uint8* src_y,
               int src_stride_y,
               uint8* dst_argb,
               int dst_stride_argb,
               int width,
...
// Convert JNV21 to ARGB.
LIBYUV_API
int JNV21ToARGB(const uint8* src_y,
               int src_stride_y,
               const uint8* src_vu,
               int src_stride_vu,
               uint8* dst_argb,
