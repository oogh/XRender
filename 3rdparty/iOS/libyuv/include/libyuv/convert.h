...
LIBYUV_API
int ABGRToJ400(const uint8* src_argb,
               int src_stride_argb,
               uint8* dst_yj,
               int dst_stride_yj,
               int width,
...
// Convert ABGR to J444.
LIBYUV_API
int ABGRToJ444(const uint8* src_abgr,
               int src_stride_abgr,
               uint8* dst_y,
               int dst_stride_y,
               uint8* dst_u,
...
LIBYUV_API
int ABGRToJNV21(const uint8* src_abgr,
                int src_stride_abgr,
                uint8* dst_y,
                int dst_stride_y,
                uint8* dst_uv,
...
LIBYUV_API
int ABGRToJNV12(const uint8* src_abgr,
                int src_stride_abgr,
                uint8* dst_y,
                int dst_stride_y,
                uint8* dst_uv,
